...
var Implements = function () {
    ...
    _createClass(Implements, [{
        ...
        value: function _AttachTraits() {
             ...
             * @type {Object}
             */
            this.Trait = new (Function.prototype.bind.apply(_Trait2.default, [null].concat([this.implements], params)))();
        ...
        value: function _CheckInterfaces() {
             ...
             * @type {Object}
             */
            var newInterface = new _Interface2.default(this.implements);
