...
var ImplementsInterface = function () {
    ...
    _createClass(ImplementsInterface, [{
         ...
         */
        value: function _getMethod(method, get_from) {
            var the_method = get_from.prototype[method];
        ...
        value: function _checkInterfaceArguments(method) {
            var class_method_args = this._interfaceArguments(this._getMethod(method, this.implements)),
        ...
        key: 'apply',
        value: function apply(the_class) {
